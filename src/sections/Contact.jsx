          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            {links.map((link) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex rounded-full border border-white/15 bg-white/[0.04] px-6 py-3 text-xs font-semibold uppercase tracking-[0.24em] text-white shadow-lg shadow-black/20 transition-colors duration-300 hover:border-cyan-400/35 hover:bg-white/[0.08]"
              >
                {link.label}
              </a>
            ))}
