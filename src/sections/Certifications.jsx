...
const Certifications = () => {
  return (
    <section
      id="certifications"
      className="relative overflow-hidden bg-gradient-to-b from-[#13141a] to-[#11131a] text-white"
    >
          ...
          {certificates.map((certificate, index) => {
            ...
            return (
              <article
                ...
                className="group overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-6 text-left shadow-xl shadow-black/35 backdrop-blur-xl"
              >
