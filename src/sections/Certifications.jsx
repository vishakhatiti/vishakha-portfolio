...
const Certifications = () => {
  return (
    <section
      id="certifications"
      className="relative overflow-hidden bg-gradient-to-b from-[#13141a] to-[#11131a] px-6 py-20 text-white sm:px-8 lg:px-12 lg:py-24"
    >
          ...
          {certificates.map((certificate, index) => {
            ...
            return (
              <article
                ...
                className="group overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-5 shadow-xl shadow-black/35 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:border-white/20"
              >
